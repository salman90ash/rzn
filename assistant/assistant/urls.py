...
urlpatterns = [
    ...
    path('tg/api/v1/<str:token>/users/<int:tg_chat_id>/settingTaskTitle/', tg_set_task_title),
    path('tg/api/v1/<str:token>/users/<int:tg_chat_id>/settingScreenshot/', tg_set_setting_screenshot),
